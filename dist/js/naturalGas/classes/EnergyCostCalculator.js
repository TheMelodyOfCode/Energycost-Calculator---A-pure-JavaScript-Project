...
class EnergyCostCalculator {
      ...
      _retrieveFormData(userInput){
             return {
                 ...
                 zustandszahl: parseFloat(userInput.target.elements.zustandszahl.value),
                 zstand_neu: parseFloat(userInput.target.elements.zstand_neu.value),
                 brennwert: parseFloat(userInput.target.elements.brennwert.value),
      ...
      _calculateFormData(retrievedFormData){
       ...
       let result = usage * retrievedFormData.brennwert * retrievedFormData.zustandszahl * retrievedFormData.kosten_kwh;
              return {
                     usage: usage,
                     result: result,
