...
class Navigation {
        ...
        _generateNavbar(){
            ...
            <nav id="navbar" class="navbar">
                ...
                <a class="active nav-el" href="index.html"><i class="fa-solid fa-fire-flame-curved"></i> Gas</a>
                <a class="nav-el" href="energy.html"><i class="fa-solid fa-plug-circle-exclamation"></i> Strom</a>
                <a class="nav-el" href="water.html"><i class="fa-solid fa-water"></i> Wasser</a>
        ...
        //     header.insertAdjacentElement("afterbegin", formField);

        //     let balanceContainer = document.createElement("div");
        //     balanceContainer.setAttribute("id", "balanceContainer");
        //     formField.insertAdjacentElement("beforeend", balanceContainer);
