    ...
    html(){
      ...
      */
      _generateFormField_html() {
        ...
        formField.innerHTML = `
        <form id="formField" action"#" method="get"></form>
        <div id="entry-group" >
        <div class="row-4">
            <div class="flex-item">
                <label for="zstand_start">Zählerstand Start</label> <br>
            <input type="number" id="zstand_start" name="zstand_start" form="formField" placeholder="z.B. 567,00" size="10" min="0.01" step="0.01" title="Der erste Zählerstand (max. zwei Nachkommastellen)" required>
            </div>
            <div class="flex-item">
                <label for="kosten_kwh">Kosten pro m3</label><br>
            <input type="number" id="kosten_kwh" name="kosten_kwh" form="formField" placeholder="z.B. 1,77€" size="10" min="0.01" min="0.01" step="0.01" title="Die Kosten in cent pro Kwh" required>
            </div>
            <div class="flex-item">
                <label for="pricePerYear">Grundpreis/Jahr</label><br>
                <input type="number" id="pricePerYear" name="pricePerYear" form="formField" placeholder="z.B. 52,00€" size="10" min="0.01" step="0.01" title="Grundpreis pro Jahr" required>
            </div>
        </div>
         <div class="row-3">
            <div class="flex-item">
                <label for="zstand_neu">Zählerstand Neu</label><br>
            <input type="number" id="zstand_neu" name="zstand_neu" form="formField" placeholder="z.B. 610" size="10" min="0.01" step="0.01" title="Der aktuelle Zählerstand" required>
            </div>
            <div class="flex-item">
